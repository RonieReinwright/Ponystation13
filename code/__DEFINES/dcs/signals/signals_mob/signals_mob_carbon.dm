...
#define COMSIG_CARBON_SEE_GAIN_WOUND "carbon_see_gain_wound" //from /datum/wound/proc/apply_wound() (/mob/living/carbon/wound_seer, /mob/living/carbon/wounded, /datum/wound/W, /obj/item/bodypart/L)
