...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		"TRAIT_SOFT_FALL" = TRAIT_SOFT_FALL,
		...
		"TRAIT_NO_UNDERWEAR_ONLY" = TRAIT_NO_UNDERWEAR_ONLY,
		"TRAIT_PONY_PREFS" = TRAIT_PONY_PREFS,
		"TRAIT_FLOATING_HELD" = TRAIT_FLOATING_HELD,
		"TRAIT_NO_UNDERSHIRT_ONLY" = TRAIT_NO_UNDERSHIRT_ONLY,
		"TRAIT_NO_SOCKS_ONLY" = TRAIT_NO_SOCKS_ONLY,
		...
		"TRAIT_VIRUS_WEAKNESS" = TRAIT_VIRUS_WEAKNESS,
