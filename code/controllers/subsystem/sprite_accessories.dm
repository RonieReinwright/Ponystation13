...
/datum/controller/subsystem/accessories/proc/setup_lists()
	...
	pony_ears_list = init_sprite_accessory_subtypes(/datum/sprite_accessory/pony_ears)[DEFAULT_SPRITE_LIST] // pr#3
	pony_tail_list = init_sprite_accessory_subtypes(/datum/sprite_accessory/pony_tail)[DEFAULT_SPRITE_LIST] // pr#3
